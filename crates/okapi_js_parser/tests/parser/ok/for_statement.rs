...
fn for_classic_statement() {
    assert_parser_script_eq!(
        ...
        r#"{"type":"Program","start":0,"end":31,"body":[{"type":"ForStatement","start":0,"end":31,"init":{"type":"VariableDeclaration","start":5,"end":14,"declarations":[{"type":"VariableDeclarator","start":9,"end":14,"id":{"type":"Identifier","start":9,"end":10,"name":"i"},"init":{"type":"Literal","start":13,"end":14,"value":0.0,"raw":"0"}}],"kind":"var"},"test":{"type":"BinaryExpression","start":16,"end":22,"left":{"type":"Identifier","start":16,"end":17,"name":"i"},"operator":"<","right":{"type":"Literal","start":20,"end":22,"value":10.0,"raw":"10"}},"update":{"type":"UpdateExpression","start":24,"end":27,"operator":"++","prefix":false,"argument":{"type":"Identifier","start":24,"end":25,"name":"i"}},"body":{"type":"BlockStatement","start":29,"end":31,"body":[]}}],"sourceType":"script"}"#
    );

    assert_parser_script_eq!(
        r#"for (let i = 5; i < 10; i++) {}"#,
        r#"{"type":"Program","start":0,"end":31,"body":[{"type":"ForStatement","start":0,"end":31,"init":{"type":"VariableDeclaration","start":5,"end":14,"declarations":[{"type":"VariableDeclarator","start":9,"end":14,"id":{"type":"Identifier","start":9,"end":10,"name":"i"},"init":{"type":"Literal","start":13,"end":14,"value":5.0,"raw":"5"}}],"kind":"let"},"test":{"type":"BinaryExpression","start":16,"end":22,"left":{"type":"Identifier","start":16,"end":17,"name":"i"},"operator":"<","right":{"type":"Literal","start":20,"end":22,"value":10.0,"raw":"10"}},"update":{"type":"UpdateExpression","start":24,"end":27,"operator":"++","prefix":false,"argument":{"type":"Identifier","start":24,"end":25,"name":"i"}},"body":{"type":"BlockStatement","start":29,"end":31,"body":[]}}],"sourceType":"script"}"#
    );

    assert_parser_script_eq!(
        r#"for (let i = 5, j = 6; i < j; ++j) {}"#,
        r#"{"type":"Program","start":0,"end":37,"body":[{"type":"ForStatement","start":0,"end":37,"init":{"type":"VariableDeclaration","start":5,"end":21,"declarations":[{"type":"VariableDeclarator","start":9,"end":14,"id":{"type":"Identifier","start":9,"end":10,"name":"i"},"init":{"type":"Literal","start":13,"end":14,"value":5.0,"raw":"5"}},{"type":"VariableDeclarator","start":16,"end":21,"id":{"type":"Identifier","start":16,"end":17,"name":"j"},"init":{"type":"Literal","start":20,"end":21,"value":6.0,"raw":"6"}}],"kind":"let"},"test":{"type":"BinaryExpression","start":23,"end":28,"left":{"type":"Identifier","start":23,"end":24,"name":"i"},"operator":"<","right":{"type":"Identifier","start":27,"end":28,"name":"j"}},"update":{"type":"UpdateExpression","start":30,"end":33,"operator":"++","prefix":true,"argument":{"type":"Identifier","start":32,"end":33,"name":"j"}},"body":{"type":"BlockStatement","start":35,"end":37,"body":[]}}],"sourceType":"script"}"#
    );
