...
fn exponent_unary_parenthesized() {
    ...
    assert_parser_script_eq!(
        r#"(typeof ident) ** 2;"#,
        r#"{"type":"Program","start":0,"end":20,"body":[{"type":"ExpressionStatement","start":0,"end":20,"expression":{"type":"BinaryExpression","start":0,"end":19,"left":{"type":"UnaryExpression","start":1,"end":13,"operator":"typeof","prefix":true,"argument":{"type":"Identifier","start":8,"end":13,"name":"ident"}},"operator":"**","right":{"type":"Literal","start":18,"end":19,"value":2.0,"raw":"2"}}}],"sourceType":"script"}"#
    );

    assert_parser_script_eq!(
        r#"(-3) ** 2;"#,
        r#"{"type":"Program","start":0,"end":10,"body":[{"type":"ExpressionStatement","start":0,"end":10,"expression":{"type":"BinaryExpression","start":0,"end":9,"left":{"type":"UnaryExpression","start":1,"end":3,"operator":"-","prefix":true,"argument":{"type":"Literal","start":2,"end":3,"value":3.0,"raw":"3"}},"operator":"**","right":{"type":"Literal","start":8,"end":9,"value":2.0,"raw":"2"}}}],"sourceType":"script"}"#
    );
