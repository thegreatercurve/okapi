...
fn assignment_target() {
    ...
    assert_parse_module_eq!(
        r#"(((foo))) = bar;"#,
        r#"{"type":"Program","start":0,"end":16,"body":[{"type":"ExpressionStatement","start":0,"end":16,"expression":{"type":"AssignmentExpression","start":0,"end":15,"operator":"=","left":{"type":"Identifier","start":3,"end":6,"name":"foo"},"right":{"type":"Identifier","start":12,"end":15,"name":"bar"}}}],"sourceType":"module"}"#
    );
    assert_parse_module_eq!(
        r#"a["test"] = bar;"#,
