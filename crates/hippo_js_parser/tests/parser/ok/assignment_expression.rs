...
fn assignment_expression() {
    assert_parser_script_eq!(
        r#"foo -= bar;"#,
        r#"{"type":"Program","start":0,"end":11,"body":[{"type":"ExpressionStatement","start":0,"end":11,"expression":{"type":"AssignmentExpression","start":0,"end":10,"operator":"-=","left":{"type":"Identifier","start":0,"end":3,"name":"foo"},"right":{"type":"Identifier","start":7,"end":10,"name":"bar"}}}],"sourceType":"script"}"#
    );
}

#[test]
fn assignment_expression_with_nested_assignment_expression() {
    assert_parser_script_eq!(
        r#"foo += bar = b ??= 3;"#,
...
#[test]
fn assignment_expression_with_grouping_expression() {
    assert_parser_script_eq!(
        r#"(foo = bar);"#,
...
#[test]
fn assignment_expression_with_array_binding_pattern() {
    assert_parser_script_eq!(
        r#"[foo, bar = "default", ...rest] = baz;"#,
        r#"{"type":"Program","start":0,"end":38,"body":[{"type":"ExpressionStatement","start":0,"end":38,"expression":{"type":"AssignmentExpression","start":0,"end":37,"operator":"=","left":{"type":"ArrayPattern","start":0,"end":31,"elements":[{"type":"Identifier","start":1,"end":4,"name":"foo"},{"type":"AssignmentPattern","start":6,"end":21,"left":{"type":"Identifier","start":6,"end":9,"name":"bar"},"right":{"type":"Literal","start":12,"end":21,"value":"default","raw":"\"default\""}},{"type":"RestElement","start":23,"end":30,"argument":{"type":"Identifier","start":26,"end":30,"name":"rest"}}]},"right":{"type":"Identifier","start":34,"end":37,"name":"baz"}}}],"sourceType":"script"}"#
    );

    assert_parser_script_eq!(
        r#"[,,,foo,bar] = baz;"#,
        r#"{"type":"Program","start":0,"end":19,"body":[{"type":"ExpressionStatement","start":0,"end":19,"expression":{"type":"AssignmentExpression","start":0,"end":18,"operator":"=","left":{"type":"ArrayPattern","start":0,"end":12,"elements":[null,null,null,{"type":"Identifier","start":4,"end":7,"name":"foo"},{"type":"Identifier","start":8,"end":11,"name":"bar"}]},"right":{"type":"Identifier","start":15,"end":18,"name":"baz"}}}],"sourceType":"script"}"#
    );
}

#[test]
fn assignment_expression_with_object_binding_pattern() {
    assert_parser_script_eq!(
        r#"({ bar, baz } = {});"#,
    ...
    assert_parser_script_eq!(
        r#"({baz = "default"} = {});"#,
        r#"{"type":"Program","start":0,"end":25,"body":[{"type":"ExpressionStatement","start":0,"end":25,"expression":{"type":"AssignmentExpression","start":1,"end":23,"operator":"=","left":{"type":"ObjectPattern","start":1,"end":18,"properties":[{"type":"Property","start":2,"end":17,"method":false,"shorthand":true,"computed":false,"key":{"type":"Identifier","start":2,"end":5,"name":"baz"},"kind":"init","value":{"type":"AssignmentPattern","start":2,"end":17,"left":{"type":"Identifier","start":2,"end":5,"name":"baz"},"right":{"type":"Literal","start":8,"end":17,"value":"default","raw":"\"default\""}}}]},"right":{"type":"ObjectExpression","start":21,"end":23,"properties":[]}}}],"sourceType":"script"}"#
    );
