...
fn module_export_from_clause() {
    assert_parser_eq!(
        r#"export * from "foo";"#,
        r#"{"type":"Program","start":0,"end":20,"body":[{"type":"ExportAllDeclaration","start":0,"end":20,"exported":null,"source":{"type":"Literal","start":14,"end":19,"value":"foo","raw":"\"foo\""}}],"sourceType":"script"}"#
    );
}
...
fn module_export_from_clause_with_module_name_export() {
    assert_parser_eq!(
        ...
        r#"{"type":"Program","start":0,"end":27,"body":[{"type":"ExportAllDeclaration","start":0,"end":27,"exported":{"type":"Identifier","start":12,"end":15,"name":"foo"},"source":{"type":"Literal","start":21,"end":26,"value":"bar","raw":"\"bar\""}}],"sourceType":"script"}"#
    );
}
...
fn module_named_exports() {
    assert_parser_eq!(
        r#"export {};"#,
        r#"{"type":"Program","start":0,"end":10,"body":[{"type":"ExportNamedDeclaration","start":0,"end":10,"declaration":null,"specifiers":[],"source":null}],"sourceType":"script"}"#
    );

    assert_parser_eq!(
        r#"export {} from "foo";"#,
        r#"{"type":"Program","start":0,"end":21,"body":[{"type":"ExportNamedDeclaration","start":0,"end":21,"declaration":null,"specifiers":[],"source":{"type":"Literal","start":15,"end":20,"value":"foo","raw":"\"foo\""}}],"sourceType":"script"}"#
    );
}
...
fn module_export_with_declaration() {
    assert_parser_eq!(
        ...
        r#"{"type":"Program","start":0,"end":23,"body":[{"type":"ExportNamedDeclaration","start":0,"end":23,"declaration":{"type":"VariableDeclaration","start":7,"end":23,"declarations":[{"type":"VariableDeclarator","start":11,"end":22,"id":{"type":"Identifier","start":11,"end":14,"name":"foo"},"init":{"type":"Literal","start":17,"end":22,"value":"bar","raw":"\"bar\""}}],"kind":"let"},"specifiers":[],"source":null}],"sourceType":"script"}"#
    );
    ...
    // assert_parser_eq!(
    //     r#"export class Foo () {};"#,
    //     r#"{"type":"Program","start":0,"end":20,"body":[{"type":"ExportNamedDeclaration","start":0,"end":19,"declaration":{"type":"ClassDeclaration","start":7,"end":19,"id":{"type":"Identifier","start":13,"end":16,"name":"Foo"},"superClass":null,"body":{"type":"ClassBody","start":17,"end":19,"body":[]}},"specifiers":[],"source":null},{"type":"EmptyStatement","start":19,"end":20}],"sourceType":"script"}"#
    // );
}
