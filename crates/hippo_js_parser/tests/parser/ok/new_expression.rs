...
fn new_expression() {
    ...
    assert_parser_eq!(
        r#"new foo.baz()"#,
        r#"{"type":"Program","start":0,"end":13,"body":[{"type":"ExpressionStatement","start":0,"end":13,"expression":{"type":"NewExpression","start":0,"end":13,"callee":{"type":"MemberExpression","start":4,"end":11,"object":{"type":"Identifier","start":4,"end":7,"name":"foo"},"property":{"type":"Identifier","start":8,"end":11,"name":"baz"},"computed":false,"optional":false},"arguments":[]}}],"sourceType":"module"}"#
    );
