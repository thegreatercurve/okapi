...
fn module_import_specifier() {
    assert_parser_eq!(
        r#"import "foo";"#,
        r#"{"type":"Program","start":0,"end":13,"body":[{"type":"ImportDeclaration","start":0,"end":13,"specifiers":[],"source":{"type":"Literal","start":7,"end":12,"value":"foo","raw":"\"foo\""}}],"sourceType":"script"}"#
    );
}
...
fn module_imported_default_binding() {
    assert_parser_eq!(
        ...
        r#"{"type":"Program","start":0,"end":22,"body":[{"type":"ImportDeclaration","start":0,"end":22,"specifiers":[{"type":"ImportDefaultSpecifier","start":7,"end":10,"local":{"type":"Identifier","start":7,"end":10,"name":"foo"}}],"source":{"type":"Literal","start":16,"end":21,"value":"foo","raw":"\"foo\""}}],"sourceType":"script"}"#
    );
}
...
fn module_name_space_import() {
    assert_parser_eq!(
        ...
        r#"{"type":"Program","start":0,"end":27,"body":[{"type":"ImportDeclaration","start":0,"end":27,"specifiers":[{"type":"ImportNamespaceSpecifier","start":7,"end":15,"local":{"type":"Identifier","start":12,"end":15,"name":"foo"}}],"source":{"type":"Literal","start":21,"end":26,"value":"foo","raw":"\"foo\""}}],"sourceType":"script"}"#
    );
}
...
fn module_named_imports() {
    assert_parser_eq!(
        r#"import {} from "foo";"#,
        r#"{"type":"Program","start":0,"end":21,"body":[{"type":"ImportDeclaration","start":0,"end":21,"specifiers":[],"source":{"type":"Literal","start":15,"end":20,"value":"foo","raw":"\"foo\""}}],"sourceType":"script"}"#
    );
...
fn module_imported_default_binding_and_name_space_import() {
    assert_parser_eq!(
        ...
        r#"{"type":"Program","start":0,"end":32,"body":[{"type":"ImportDeclaration","start":0,"end":32,"specifiers":[{"type":"ImportDefaultSpecifier","start":7,"end":10,"local":{"type":"Identifier","start":7,"end":10,"name":"foo"}},{"type":"ImportNamespaceSpecifier","start":12,"end":20,"local":{"type":"Identifier","start":17,"end":20,"name":"bar"}}],"source":{"type":"Literal","start":26,"end":31,"value":"baz","raw":"\"baz\""}}],"sourceType":"script"}"#
    );
}
