...
fn rest_property_assignment_target() {
    assert_parser_eq!(
        r#"({ ...abcd } = a);"#,
        r#"{"type":"Program","start":0,"end":18,"body":[{"type":"ExpressionStatement","start":0,"end":18,"expression":{"type":"AssignmentExpression","start":1,"end":16,"operator":"=","left":{"type":"ObjectPattern","start":1,"end":12,"properties":[{"type":"RestElement","start":3,"end":10,"argument":{"type":"Identifier","start":6,"end":10,"name":"abcd"}}]},"right":{"type":"Identifier","start":15,"end":16,"name":"a"}}}],"sourceType":"module"}"#
    );
