...
fn call_expression() {
    assert_parser_eq!(
        r#"foo(bar)"#,
        r#"{"type":"Program","start":0,"end":8,"body":[{"type":"ExpressionStatement","start":0,"end":8,"expression":{"type":"CallExpression","start":0,"end":8,"callee":{"type":"Identifier","start":0,"end":3,"name":"foo"},"arguments":[{"type":"Identifier","start":4,"end":7,"name":"bar"}],"optional":false}}],"sourceType":"module"}"#
    );

    assert_parser_eq!(
        r#"foo(bar).baz"#,
        r#"{"type":"Program","start":0,"end":12,"body":[{"type":"ExpressionStatement","start":0,"end":12,"expression":{"type":"MemberExpression","start":0,"end":12,"object":{"type":"CallExpression","start":0,"end":8,"callee":{"type":"Identifier","start":0,"end":3,"name":"foo"},"arguments":[{"type":"Identifier","start":4,"end":7,"name":"bar"}],"optional":false},"property":{"type":"Identifier","start":9,"end":12,"name":"baz"},"computed":false,"optional":false}}],"sourceType":"module"}"#
    );

    assert_parser_eq!(
        r#"foo(bar).baz()"#,
        r#"{"type":"Program","start":0,"end":14,"body":[{"type":"ExpressionStatement","start":0,"end":14,"expression":{"type":"CallExpression","start":0,"end":14,"callee":{"type":"MemberExpression","start":0,"end":12,"object":{"type":"CallExpression","start":0,"end":8,"callee":{"type":"Identifier","start":0,"end":3,"name":"foo"},"arguments":[{"type":"Identifier","start":4,"end":7,"name":"bar"}],"optional":false},"property":{"type":"Identifier","start":9,"end":12,"name":"baz"},"computed":false,"optional":false},"arguments":[],"optional":false}}],"sourceType":"module"}"#
    );
