...
fn template_literal() {
    assert_parser_eq!(
        r#"let a = `foo`;"#,
        r#"{"type":"Program","start":0,"end":14,"body":[{"type":"VariableDeclaration","start":0,"end":14,"kind":"let","declarations":[{"type":"VariableDeclarator","start":4,"end":13,"id":{"type":"Identifier","start":4,"end":5,"name":"a"},"init":{"type":"TemplateLiteral","start":8,"end":13,"expressions":[],"quasis":[{"type":"TemplateElement","start":9,"end":12,"value":{"raw":"foo","cooked":"foo"},"tail":true}]}}]}],"sourceType":"module"}"#
    );
