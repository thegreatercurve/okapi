...
fn function_expression_async_generator() {
  ...
  yield;
        ...
        r#"{"type":"Program","start":0,"end":42,"body":[{"type":"VariableDeclaration","start":0,"end":42,"declarations":[{"type":"VariableDeclarator","start":4,"end":41,"id":{"type":"Identifier","start":4,"end":7,"name":"foo"},"init":{"type":"FunctionExpression","start":10,"end":41,"id":null,"expression":false,"generator":true,"async":true,"params":[],"body":{"type":"BlockStatement","start":29,"end":41,"body":[{"type":"ExpressionStatement","start":33,"end":39,"expression":{"type":"YieldExpression","start":33,"end":38,"delegate":false,"argument":null}}]}}}],"kind":"let"}],"sourceType":"module"}"#
    );
}
