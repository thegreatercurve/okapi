...
fn paren_or_arrow_expression() {
    ...
    assert_parser_eq!(
        r#"(foo) => {};"#,
        r#"{"type":"Program","start":0,"end":12,"body":[{"type":"ExpressionStatement","start":0,"end":12,"expression":{"type":"ArrowFunctionExpression","start":0,"end":11,"id":null,"expression":false,"generator":false,"async":false,"params":[{"type":"Identifier","start":1,"end":4,"name":"foo"}],"body":{"type":"BlockStatement","start":9,"end":11,"body":[]}}}],"sourceType":"module"}"#
    );

    assert_parser_eq!(
        r#"(5 + 5);"#,
        r#"{"type":"Program","start":0,"end":8,"body":[{"type":"ExpressionStatement","start":0,"end":8,"expression":{"type":"BinaryExpression","start":1,"end":6,"left":{"type":"Literal","start":1,"end":2,"value":5,"raw":"5"},"operator":"+","right":{"type":"Literal","start":5,"end":6,"value":5,"raw":"5"}}}],"sourceType":"module"}"#
    );
