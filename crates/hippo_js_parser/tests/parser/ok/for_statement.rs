...
fn for_of_statement() {
    ...
    assert_parser_eq!(
        r#"for ({} of []) {}"#,
        r#"{"type":"Program","start":0,"end":17,"body":[{"type":"ForOfStatement","start":0,"end":17,"await":false,"left":{"type":"ObjectPattern","start":5,"end":7,"properties":[]},"right":{"type":"ArrayExpression","start":11,"end":13,"elements":[]},"body":{"type":"BlockStatement","start":15,"end":17,"body":[]}}],"sourceType":"module"}"#
    );
}
...
fn for_in_statement() {
    assert_parser_eq!(
        r#"for (const foo in {}) {}"#,
        r#"{"type":"Program","start":0,"end":24,"body":[{"type":"ForInStatement","start":0,"end":24,"left":{"type":"VariableDeclaration","start":5,"end":14,"declarations":[{"type":"VariableDeclarator","start":11,"end":14,"id":{"type":"Identifier","start":11,"end":14,"name":"foo"},"init":null}],"kind":"const"},"right":{"type":"ObjectExpression","start":18,"end":20,"properties":[]},"body":{"type":"BlockStatement","start":22,"end":24,"body":[]}}],"sourceType":"module"}"#
    );

    assert_parser_eq!(
        r#"for ({} in []) {}"#,
        r#"{"type":"Program","start":0,"end":17,"body":[{"type":"ForInStatement","start":0,"end":17,"left":{"type":"ObjectPattern","start":5,"end":7,"properties":[]},"right":{"type":"ArrayExpression","start":11,"end":13,"elements":[]},"body":{"type":"BlockStatement","start":15,"end":17,"body":[]}}],"sourceType":"module"}"#
    );
}
...
fn for_of_async_statement() {
    assert_parser_eq!(
        ...
        r#"{"type":"Program","start":0,"end":26,"body":[{"type":"ForOfStatement","start":0,"end":26,"await":true,"left":{"type":"VariableDeclaration","start":11,"end":16,"declarations":[{"type":"VariableDeclarator","start":15,"end":16,"id":{"type":"Identifier","start":15,"end":16,"name":"a"},"init":null}],"kind":"let"},"right":{"type":"ArrayExpression","start":20,"end":22,"elements":[]},"body":{"type":"BlockStatement","start":24,"end":26,"body":[]}}],"sourceType":"module"}"#
    );
}
