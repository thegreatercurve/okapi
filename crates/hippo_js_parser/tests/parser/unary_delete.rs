...
fn unary_delete() {
    ...
    assert_parser_eq!(r#"delete obj.#member.key;"#, r#"undefined"#);
    assert_parser_eq!(r#"delete (obj.#member).key;"#, r#"undefined"#);
    assert_parser_eq!(r#"delete func().#member.key;"#, r#"undefined"#);
    assert_parser_eq!(r#"delete (func().#member).key;"#, r#"undefined"#);
    assert_parser_eq!(r#"delete obj?.#member.key;"#, r#"undefined"#);
    assert_parser_eq!(r#"delete (obj?.#member).key;"#, r#"undefined"#);
    assert_parser_eq!(r#"delete obj?.inner.#member.key;"#, r#"undefined"#);
    assert_parser_eq!(r#"delete (obj?.inner.#member).key;"#, r#"undefined"#);
    assert_parser_eq!(
        r#"delete obj[key];"#,
    ...
    assert_parser_eq!(r#"delete obj?.inner.#member[key];"#, r#"undefined"#);
    assert_parser_eq!(r#"delete (obj?.inner.#member)[key];"#, r#"undefined"#);
    assert_parser_eq!(r#"delete (obj.#key, obj.key);"#, r#"undefined"#);
    assert_parser_eq!(r#"delete (#key in obj);"#, r#"undefined"#);
}
