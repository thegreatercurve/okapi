...
fn for_statement() {
    ...
    assert_parse_module_eq!(
        r#"for (foo in {}) {}"#,
        r#"{"type":"Program","start":0,"end":18,"body":[{"type":"ForInStatement","start":0,"end":18,"left":{"type":"Identifier","start":5,"end":8,"name":"foo"},"right":{"type":"ObjectExpression","start":12,"end":14,"properties":[]},"body":{"type":"BlockStatement","start":16,"end":18,"body":[]}}],"sourceType":"script"}"#
    );
    assert_parse_module_eq!(
        r#"for (;;) {}"#,
