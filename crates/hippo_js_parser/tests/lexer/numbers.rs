...
#[test]
fn numbers_zero() {
    assert_lexer_eq!("0", vec![number_literal("0", "0", 0, 1, 1, 1)]);
}
...
fn numbers_integers() {
    assert_lexer_eq!(
        "1234567890",
        vec![number_literal("1234567890", "1234567890", 0, 10, 1, 1)]
    );
...
fn numbers_binary_integer_literals() {
    assert_lexer_eq!(
        "0b10101010",
        vec![number_literal("0b10101010", "170", 0, 10, 1, 1)]
    );
...
fn numbers_binary_integer_literals_invalid() {
    assert_lexer_eq!(
        "0b1012111111",
        vec![
            number_literal("0b101", "5", 0, 5, 1, 1),
            number_literal("2111111", "2111111", 5, 12, 1, 6)
        ]
    );
}
...
fn numbers_octal_integer_literals_modern() {
    assert_lexer_eq!(
        "0o12345670",
        vec![number_literal("0o12345670", "2739128", 0, 10, 1, 1)]
    );
...
fn numbers_octal_integer_literals_modern_invalid() {
    assert_lexer_eq!(
        "0o123456780",
        vec![
            number_literal("0o1234567", "342391", 0, 9, 1, 1),
            number_literal("80", "80", 9, 11, 1, 10)
        ]
    );
}
...
fn numbers_hexadecimal_integer_literals_invalid() {
    assert_lexer_eq!(
        ...
        vec![
            number_literal("0X1234567890abcdef", "1311768467294899700", 0, 18, 1, 1),
...
fn numbers_octal_integer_literals_legacy() {
    assert_lexer_eq!(
        "0012345670",
        vec![number_literal("0012345670", "2739128", 0, 10, 1, 1)]
    );
...
fn numbers_octal_integer_literals_legacy_invalid() {
    assert_lexer_eq!(
        "00123459670",
        vec![
            number_literal("0012345", "5349", 0, 7, 1, 1),
            number_literal("9670", "9670", 7, 11, 1, 8)
        ]
    );
    ...
    assert_lexer_eq!(
        "00123456970",
        vec![
            number_literal("00123456", "42798", 0, 8, 1, 1),
            number_literal("970", "970", 8, 11, 1, 9)
        ]
    );
}
...
fn numbers_numeric_separator() {
    assert_lexer_eq!(
        "123_456_789",
        vec![number_literal("123_456_789", "123456789", 0, 11, 1, 1)]
    );
}
