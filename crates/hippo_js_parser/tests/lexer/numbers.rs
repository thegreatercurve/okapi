...
fn numbers_integers() {
    assert_lexer_eq!(
        "1234567890",
        vec![create_number_literal("1234567890".to_string(), 0, 10)]
    );
...
fn numbers_floats() {
    assert_lexer_eq!(
        "12345.67890",
        vec![create_number_literal("12345.67890".to_string(), 0, 13)]
    );

    assert_lexer_eq!(
        "0.1234567890",
        vec![create_number_literal(".1234567890".to_string(), 0, 13)]
    );
...
fn numbers_binary_integer_literals() {
    assert_lexer_eq!(
        "0b10101010",
        vec![create_number_literal("170".to_string(), 0, 10)]
    );
...
fn numbers_octal_integer_literals_legacy() {
    assert_lexer_eq!(
        "0o12345670",
        vec![create_number_literal("2739128".to_string(), 0, 10)]
    );
...
//     assert_lexer_eq!(
//         "123_456_789",
//         vec![create_number_literal("123456789".to_string(), 0, 9)]
//     );
// }
